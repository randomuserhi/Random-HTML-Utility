...
function parseOptions<T extends {}>(template: T, options: any | undefined): T {
...
export namespace Rest {
    ...
    export function fetch<T, P extends any[] = []>(options: Options<T, P>): FetchFunc<T, P> {
        ...
        if (partialOpt.url === undefined) throw new SyntaxError("No fetch url was provided.");
        if (partialOpt.fetch === undefined) throw new SyntaxError("No fetch options were provided.");
        if (partialOpt.callback === undefined) throw new SyntaxError("No callback was provided.");
        ...
        if (opt.parser !== undefined) {
            return (async function(...params: P) {
                ...
                for (const key in payload.urlParams) if (payload.urlParams[key] !== undefined) url.searchParams.append(key, payload.urlParams[key]);
    ...
    export function fetchJSON<T, P extends any[] = []>(options: Options<T, P>): FetchFunc<T, P> {
        ...
        if (opt.parser !== undefined) {
            ...
            opt.parser = async function(...params: P): Promise<Payload> {
                ...
                if (payload.body !== undefined) payload.body = JSON.stringify(payload.body);
                return payload;
            };
        }
